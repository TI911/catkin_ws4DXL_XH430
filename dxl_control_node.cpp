...
int bulk_read_write()
{
	...
	dxl_addparam_result = groupBulkRead.addParam(DXL1_ID, ADDR_XH_PRESENT_POSITION, LEN_PRO_PRESENT_POSITION);
	...
	dxl_addparam_result = groupBulkRead.addParam(DXL2_ID, ADDR_XH_LED_RED, LEN_PRO_LED_RED);
	if (dxl_addparam_result != true)
	{
	...
	while(1)
	{
	    ...
	    dxl_addparam_result = groupBulkWrite.addParam(DXL1_ID, ADDR_XH_GOAL_POSITION, LEN_PRO_GOAL_POSITION, param_goal_position);
	    if (dxl_addparam_result != true)
	    {
	    ...
	    // Add parameter storage for Dynamixel#2 LED value
	    dxl_addparam_result = groupBulkWrite.addParam(DXL2_ID, ADDR_XH_LED_RED, LEN_PRO_LED_RED, &dxl_led_value[index]);
	    if (dxl_addparam_result != true)
	    {
	    ...
	    do
	    {
	      ...
	      dxl_getdata_result = groupBulkRead.isAvailable(DXL1_ID, ADDR_XH_PRESENT_POSITION, LEN_PRO_PRESENT_POSITION);
	      ...
	      dxl_getdata_result = groupBulkRead.isAvailable(DXL2_ID, ADDR_XH_LED_RED, LEN_PRO_LED_RED);
	      if (dxl_getdata_result != true)
	      {
	      ...
	      dxl1_present_position = groupBulkRead.getData(DXL1_ID, ADDR_XH_PRESENT_POSITION, LEN_PRO_PRESENT_POSITION);

	      // Get LED value
	      dxl2_led_value_read = groupBulkRead.getData(DXL2_ID, ADDR_XH_LED_RED, LEN_PRO_LED_RED);
